...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net myip_0_o_led1 [get_bd_ports led1] [get_bd_pins myip_0/o_led1]
  connect_bd_net -net myip_0_o_led2 [get_bd_ports led2] [get_bd_pins myip_0/o_led2]
  connect_bd_net -net myip_0_o_led3 [get_bd_ports led3] [get_bd_pins myip_0/o_led3]
  connect_bd_net -net myip_0_o_led4 [get_bd_ports led4] [get_bd_pins myip_0/o_led4]
